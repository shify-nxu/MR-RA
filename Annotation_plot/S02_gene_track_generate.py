...
## Bigwig
metadata = pd.read_table("/home/sdc1/Shify/Data_public/ENCODE/Immune-cells/rs3850765/metadata.tsv")
...
#for cell_id in cell_ids: # Reordered the cell type
    ...
    tf = metadata.loc[cell_id,"Experiment target"]

    config[f"{cell} ChIP"] = {
        "file": f"/home/sdc1/Shify/Data_public/ENCODE/Immune-cells/rs3850765/{cell_id}.bw",
...
## Hi-C
#config["Hi-C"] = {
#    "file": "/home/sdc1/Shify/Data_public/ENCODE/Immune-cells/rs3850765/4DNFI2TK7L2F_50000.cool",
#    "Title": "H1-hESC Hi-C", "min_value": 5, "file_type": "hic_matrix", "transform": "log2p","depth": 300000, "height": 10 
#}
#space_index += 1
#config[f"spacer{space_index}"] = {"height": 0.5, "file_type":"spacer"}
...
with open(f"{PATH}/tracks-use-hic.ini", "w") as f:
    config.write(f)
